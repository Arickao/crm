...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#addBtn").click(function () {
			$.ajax({
				url:"workbench/contacts/getAllUserIdAndName",
				type:"get",
				dataType:"json",
		...
		$.ajax({
			...
			success:function (data) {
				...
				$.each(data.dataList,function (i,n) {
					...
					html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/contacts/detail?id='+n.id+'\';">'+n.fullname+'</a></td>';
		...
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="createForm" method="post" action="workbench/contacts/save">
						...
						<div class="form-group" style="position: relative;">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control time" id="create-birth" name="birth" readonly>
							</div>
						</div>
						...
						<div style="position: relative;top: 15px;">
							...
							<div class="form-group">
								...
								<div class="col-sm-10" style="width: 300px;">
									<input type="text" class="form-control time" id="create-nextContactTime1" name="nextContactTime" readonly>
								</div>
							</div>
						</div>
