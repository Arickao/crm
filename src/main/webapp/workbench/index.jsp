<%@ page import="org.example.crm.setting.domain.User" %>
...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			if(a == "null" || a == ""){
				window.location.href="welcome/login.jsp";
			}
		...
		<ul>
			<li class="dropdown user-dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="welcome/login.jsp" <%--data-toggle="modal" data-target="#exitModal"--%>><span class="glyphicon glyphicon-off"></span> 退出</a></li>
				</ul>
			</li>
		</ul>
	</div>
